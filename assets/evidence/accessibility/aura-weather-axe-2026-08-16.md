# Aura Weather case study — axe scan 2026-08-16

- Tool: axe-core 4.13.0 (@axe-core/playwright, Chromium)
- URL/viewport: `/work/aura-weather/` @ 1280px — repository static files served locally
  (byte-identical to what GitHub Pages deploys for this commit)
- Rule tags: WCAG 2.0/2.1 A + AA and axe best-practice
- Violations: 0 (critical: 0, serious: 0, moderate: 0, minor: 0) — 42 rule passes
...
- Notes: this capture was taken together with two fixes it motivated — the
  ...
  [`aura-weather-axe-2026-08-16.json`](./aura-weather-axe-2026-08-16.json).
