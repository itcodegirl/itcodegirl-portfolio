# CodeHerWay case study — axe scan 2026-08-16

- Tool: axe-core 4.13.0 (@axe-core/playwright, Chromium)
- URL/viewport: `/work/codeherway/` @ 1280px — repository static files served locally
...
- Notes: this capture was taken together with two fixes it motivated — the
  ...
  [`codeherway-axe-2026-08-16.json`](./codeherway-axe-2026-08-16.json).
